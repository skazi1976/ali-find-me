...
const i18n = {
  ...
  it: {
    heroTitle: "✨ Trova il tuo prodotto perfetto",
    heroSubtitle: "Cerca prodotti moda e lifestyle ai migliori prezzi su AliExpress",
    welcome: "Ciao! Sono qui per aiutarti a trovare prodotti fantastici su AliExpress.\nDimmi cosa cerchi e troverò le migliori offerte! 🛍️",
    inputPlaceholder: "Cosa stai cercando? (es. abito da sera, leggings sportivi...)",
    searching: "Ricerca in corso...",
    foundResults: "{count} prodotti trovati! Ecco le migliori offerte:",
    noResults: "Nessun risultato per questa parola. Prova un'altra parola o scegli tra i suggerimenti:",
    viewProduct: "Vedi e Compra →",
    orders: "ordini",
    clearResults: "Cancella",
    loadMore: "Carica altri prodotti",
    categoriesTitle: "🏷️ Categorie popolari",
    trendingTitle: "🔥 Di tendenza",
    howTitle: "💡 Come funziona?",
    step1Title: "Cerca",
    step1Desc: "Scrivi cosa cerchi in qualsiasi lingua",
    step2Title: "Ottieni risultati",
    step2Desc: "Il nostro sistema trova le migliori offerte per te",
    step3Title: "Compra a poco",
    step3Desc: "Clicca su un prodotto e vai direttamente su AliExpress",
    disclaimer: "Questo sito utilizza link di affiliazione. Il tuo acquisto non costerà di più, ma potremmo ricevere una piccola commissione.",
    recentSearches: "Ricerche recenti:",
    alsoSearch: "Cercano anche:",
    sortBy: "Ordina:",
    priceRange: "Prezzo:",
    priceFrom: "Da",
    priceTo: "A",
    apply: "Filtra",
    sortPopular: "Più venduti",
    sortCheap: "Più economici",
    sortExpensive: "Più costosi",
    sortNew: "Più recenti",
    sortRating: "Valutazione",
    myFavorites: "I miei preferiti",
    noFavorites: "Ancora nessun preferito",
    shareText: "Guarda cosa ho trovato su AliExpress!",
    recentlyViewedTitle: "👁️ Visti di recente",
    clearViewed: "Cancella",
    myAlerts: "Avvisi di prezzo",
    noAlerts: "Nessun avviso di prezzo attivo",
    setAlert: "Avvisa quando il prezzo scende sotto:",
    save: "Salva",
    cancel: "Annulla",
    priceDropped: "Prezzo sceso!",
    targetPrice: "Prezzo target",
    dailyDealsTitle: "⏰ Offerte del giorno",
    dealsEndsIn: "Termina tra",
    spinTitle: "🎰 Gira e Vinci!",
    spinBtn: "Gira!",
    spinAlreadyUsed: "Hai già girato oggi! Torna domani 😊",
    spinCongrats: "Congratulazioni! 🎉",
    spinTryAgain: "Riprova domani",
    spinGetPrize: "Riscatta premio",
    chatHelp: "Posso aiutarti a trovare prodotti su AliExpress! Scrivi cosa cerchi o chiedi consigli 🛒",
    chatRecommending: "Controllo i consigli...",
    chatRefining: "Ricerca {query}...",
    quickCheapest: "🔽 Più economici",
    quickRated: "⭐ Più votati",
    quickNewest: "🆕 Più recenti",
    quickSimilar: "💡 Consiglia",
    installTitle: "Installa l'app!", installDesc: "Accesso rapido alle offerte dalla schermata home", installBtn: "Installa",
    pointsTitle: "I miei punti", pointsBalance: "punti",
    pointsEarn: "+{pts} punti guadagnati!",
    pointsRedeem: "Riscatta punti", pointsHistory: "Cronologia",
    pointsDaily: "Bonus giornaliero!", pointsSearch: "Ricerca",
    pointsClick: "Visualizzazione prodotto", pointsShare: "Condividi",
    pointsFav: "Preferito", pointsSpin: "Gira",
    pointsCoupon5: "Coupon 5%", pointsCoupon10: "Coupon 10%",
    pointsFreeShip: "Spedizione gratuita", pointsCoupon5off: "Coupon $5",
    pointsRedeemed: "Riscattato!", pointsNotEnough: "Punti insufficienti",
    pointsToday: "Oggi", pointsYesterday: "Ieri",
    imgSearching: "Identificazione prodotto...", imgResult: "Trovato: {desc}", imgError: "Impossibile identificare. Prova un'altra foto",
    imgTakePhoto: "Scatta foto", imgUpload: "Carica",
    nlTitle: "Offerte top nella tua casella!",
    nlDesc: "Iscriviti alla nostra newsletter settimanale e ricevi le migliori offerte via email",
    nlPlaceholder: "Inserisci la tua email",
    nlBtn: "Iscriviti",
    nlPrivacy: "Niente spam. Disiscriviti quando vuoi.",
    nlSuccess: "Iscritto! Ti invieremo le migliori offerte",
    nlPopupTitle: "Non perdere le offerte!",
    nlPopupDesc: "Unisciti a migliaia di iscritti che ricevono le offerte più calde ogni settimana",
    nlSkip: "Non ora",
    shareTitle: "Condividi questa offerta!", shareCopied: "Link copiato!",
    shareNative: "Altro...",
    findCheaper: "Trova più economico 💰",
    comparing: "Cerco alternative più economiche...",
    cheaperAlts: "Alternative più economiche 💰",
    savingsLabel: "Risparmio",
    noAlternatives: "Nessuna alternativa più economica trovata",
    originalProduct: "Prodotto originale",
    viewDeal: "Vedi e Compra →",
    aiSummary: "Riepilogo IA",
  },
  pl: {
    heroTitle: "✨ Znajdź swój idealny produkt",
    heroSubtitle: "Szukaj produktów modowych i lifestyle w najlepszych cenach na AliExpress",
    welcome: "Cześć! Pomogę Ci znaleźć świetne produkty na AliExpress.\nPowiedz, czego szukasz, a znajdę najlepsze oferty! 🛍️",
    inputPlaceholder: "Czego szukasz? (np. sukienka wieczorowa, legginsy sportowe...)",
    searching: "Szukam...",
    foundResults: "Znaleziono {count} produktów! Oto najlepsze oferty:",
    noResults: "Brak wyników dla tego słowa. Spróbuj innego słowa lub wybierz z sugestii:",
    viewProduct: "Zobacz i Kup →",
    orders: "zamówień",
    clearResults: "Wyczyść",
    loadMore: "Załaduj więcej produktów",
    categoriesTitle: "🏷️ Popularne kategorie",
    trendingTitle: "🔥 Na czasie",
    howTitle: "💡 Jak to działa?",
    step1Title: "Szukaj",
    step1Desc: "Wpisz, czego szukasz, w dowolnym języku",
    step2Title: "Otrzymaj wyniki",
    step2Desc: "Nasz system znajdzie najlepsze oferty dla Ciebie",
    step3Title: "Kup tanio",
    step3Desc: "Kliknij produkt i przejdź bezpośrednio do AliExpress",
    disclaimer: "Ta strona korzysta z linków afiliacyjnych. Twój zakup nie będzie droższy, ale możemy otrzymać małą prowizję.",
    recentSearches: "Ostatnie wyszukiwania:",
    alsoSearch: "Inni szukają też:",
    sortBy: "Sortuj:",
    priceRange: "Cena:",
    priceFrom: "Od",
    priceTo: "Do",
    apply: "Filtruj",
    sortPopular: "Bestsellery",
    sortCheap: "Najtańsze",
    sortExpensive: "Najdroższe",
    sortNew: "Najnowsze",
    sortRating: "Ocena",
    myFavorites: "Moje ulubione",
    noFavorites: "Brak ulubionych",
    shareText: "Zobacz, co znalazłem na AliExpress!",
    recentlyViewedTitle: "👁️ Ostatnio oglądane",
    clearViewed: "Wyczyść",
    myAlerts: "Alerty cenowe",
    noAlerts: "Brak aktywnych alertów cenowych",
    setAlert: "Powiadom, gdy cena spadnie poniżej:",
    save: "Zapisz",
    cancel: "Anuluj",
    priceDropped: "Cena spadła!",
    targetPrice: "Cena docelowa",
    dailyDealsTitle: "⏰ Oferty dnia",
    dealsEndsIn: "Kończy się za",
    spinTitle: "🎰 Zakręć i Wygraj!",
    spinBtn: "Zakręć!",
    spinAlreadyUsed: "Już dziś zakręciłeś! Wróć jutro 😊",
    spinCongrats: "Gratulacje! 🎉",
    spinTryAgain: "Spróbuj jutro",
    spinGetPrize: "Odbierz nagrodę",
    chatHelp: "Pomogę Ci znaleźć produkty na AliExpress! Wpisz, czego szukasz, lub poproś o rekomendacje 🛒",
    chatRecommending: "Sprawdzam rekomendacje...",
    chatRefining: "Szukam {query}...",
    quickCheapest: "🔽 Najtańsze",
    quickRated: "⭐ Najlepiej oceniane",
    quickNewest: "🆕 Najnowsze",
    quickSimilar: "💡 Poleć",
    installTitle: "Zainstaluj aplikację!", installDesc: "Szybki dostęp do ofert z ekranu głównego", installBtn: "Zainstaluj",
    pointsTitle: "Moje punkty", pointsBalance: "punktów",
    pointsEarn: "Zdobyto +{pts} punktów!",
    pointsRedeem: "Wymień punkty", pointsHistory: "Historia",
    pointsDaily: "Bonus dzienny!", pointsSearch: "Wyszukiwanie",
    pointsClick: "Wyświetlenie produktu", pointsShare: "Udostępnij",
    pointsFav: "Ulubione", pointsSpin: "Zakręć",
    pointsCoupon5: "Kupon 5%", pointsCoupon10: "Kupon 10%",
    pointsFreeShip: "Darmowa wysyłka", pointsCoupon5off: "Kupon $5",
    pointsRedeemed: "Wymieniono!", pointsNotEnough: "Za mało punktów",
    pointsToday: "Dziś", pointsYesterday: "Wczoraj",
    imgSearching: "Identyfikacja produktu...", imgResult: "Znaleziono: {desc}", imgError: "Nie udało się rozpoznać. Spróbuj innego zdjęcia",
    imgTakePhoto: "Zrób zdjęcie", imgUpload: "Prześlij",
    nlTitle: "Najlepsze oferty w Twojej skrzynce!",
    nlDesc: "Zapisz się do naszego cotygodniowego newslettera i otrzymuj najlepsze oferty e-mailem",
    nlPlaceholder: "Wpisz swój e-mail",
    nlBtn: "Zapisz się",
    nlPrivacy: "Bez spamu. Wypisz się w każdej chwili.",
    nlSuccess: "Zapisano! Wyślemy Ci najlepsze oferty",
    nlPopupTitle: "Nie przegap ofert!",
    nlPopupDesc: "Dołącz do tysięcy subskrybentów, którzy co tydzień otrzymują najgorętsze oferty",
    nlSkip: "Nie teraz",
    shareTitle: "Udostępnij tę ofertę!", shareCopied: "Link skopiowany!",
    shareNative: "Więcej...",
    findCheaper: "Znajdź taniej 💰",
    comparing: "Szukam tańszych alternatyw...",
    cheaperAlts: "Tańsze alternatywy 💰",
    savingsLabel: "Oszczędność",
    noAlternatives: "Nie znaleziono tańszych alternatyw",
    originalProduct: "Oryginalny produkt",
    viewDeal: "Zobacz i Kup →",
...
const LANG_COUNTRY_CURRENCY = {
  ...
  it: { country: "IT", currency: "EUR", symbol: "€" },
  pl: { country: "PL", currency: "PLN", symbol: "zł" },
};
...
function setLang(lang, skipNav) {
  ...
  if (!skipNav) {
    ...
    const basePath = currentPath.replace(/^\/(en|ar|ru|es|pt|tr|fr|de|it|pl)\//, "/");
    const isSubdir = /^\/(en|ar|ru|es|pt|tr|fr|de|it|pl)\//.test(currentPath);
...
const HE_EN_DICT = {
  ...
  // === Dresses, skirts, jeans, outerwear, sets (from keyword lists) ===
  "שמלת נשים": "women dress", "שמלות נשים": "women dresses", "שמלות": "dresses",
  "פרחונית": "floral", "פרחוני": "floral", "מחשוף": "v-neck low cut", "קלילה": "lightweight", "קליל": "lightweight",
  "נוחה": "comfortable", "נוח": "comfortable", "נוחים": "comfortable",
  "גינס": "jeans denim", "ג'ינס": "jeans denim", "סקיני": "skinny", "קרעים": "ripped distressed",
  "בהיר": "light", "בהירה": "light", "כהה": "dark", "כהה": "dark",
  "זקט": "blazer jacket", "גקט": "blazer jacket", "קרדיגן": "cardigan", "עליונית": "cardigan top layer",
  "חצאית": "skirt", "חצאיות": "skirts", "מיני": "mini",
  "סט": "set", "סט בגדים": "clothes set outfit", "סט בגדים לנשים": "women clothes set outfit",
  "סט נשים": "women set outfit", "סט ספורט": "sportswear set fitness",
  "טופ": "crop top", "טופ ספורט": "sports bra top",
  "כושר": "fitness gym", "בגדי כושר": "fitness gym clothes", "אימון": "workout training",
  "בגדי אימון": "workout training clothes", "בגדי יוגה": "yoga clothes set",
  "בגדי": "clothes", "בגדי נשים": "women clothes", "בגדים": "clothes", "עם": "with",
  // === Marketing/slang terms ===
  "בזול": "cheap affordable", "איכותי": "quality premium", "איכותיים": "quality premium",
  "מבצעים": "sale deals", "סטייל": "style fashion", "לוק": "look outfit",
  "פצצה": "stunning hot", "נדירה": "unique rare", "מטורף": "amazing crazy",
  "נמכרים": "bestselling popular", "חובה": "must have essential",
  // === Original dictionary ===
  ...
  "מעיל לכלב": "pet dog jacket", "חולצה לכלב": "pet dog shirt", "סוודר לכלב": "pet dog sweater",
  ...
  "חולצה שחורה": "black shirt blouse women", "חולצה לבנה": "white shirt blouse women", "חולצה שחורה לנשים": "women black shirt blouse top",
  "חולצת נשים": "women shirt blouse top", "חולצה לנשים": "women shirt blouse top",
  "שמלה שחורה": "black dress women", "שמלה לבנה": "white dress women", "שמלה אדומה": "red dress women",
  "ורוד": "pink", "שחור": "black", "לבן": "white", "אדום": "red", "כחול": "blue",
  "ורודה": "pink", "שחורה": "black", "לבנה": "white", "אדומה": "red", "כחולה": "blue",
  "ירוק": "green", "ירוקה": "green", "צהוב": "yellow", "צהובה": "yellow",
  "סגול": "purple", "סגולה": "purple", "כתום": "orange", "כתומה": "orange",
  "אפור": "gray", "אפורה": "gray", "חום": "brown", "חומה": "brown",
  "בז'": "beige", "בז": "beige", "זהב": "gold", "כסף": "silver",
  "סקסי": "sexy", "סקסית": "sexy", "אלגנטי": "elegant", "אלגנטית": "elegant", "קז'ואל": "casual",
  "אוברסייז": "oversized", "אופנתית": "fashion", "אופנתי": "fashion",
  "טרנדית": "trendy", "טרנדי": "trendy", "יוקרתית": "luxury", "יוקרתי": "luxury",
...
const LANG_SUGGESTIONS = {
  he: ["לק ג'ל לציפורניים", "צעצועי תינוק התפתחותיים", "מוצרי טיפוח", "אביזרי ספורט", "תכשיטים", "גאדג'טים למטבח", "צעצוע דיג מגנטי", "אוזניות אלחוטיות", "שמלת ערב", "נעלי נייק", "סט האכלה לתינוק", "מנורת UV לציפורניים", "תיק החתלה", "בגדי תינוק", "צעצועי מונטסורי"],
  en: ["Gel nail polish", "Baby toys educational", "Beauty skincare", "Sports fitness accessories", "Jewelry accessories", "Home kitchen gadgets", "Wireless earbuds", "Fashion dress", "Nike shoes", "Magnetic fishing toy", "Press on nails", "UV LED nail lamp", "Smartwatch", "Baby feeding set", "Montessori toys"],
  ...
  es: ["Esmalte gel u\u00f1as", "Juguetes beb\u00e9 educativos", "Cuidado de la piel", "Accesorios fitness", "Joyer\u00eda", "Gadgets cocina", "Auriculares inal\u00e1mbricos", "Vestido", "Zapatillas Nike", "Juguete pesca magn\u00e9tico", "U\u00f1as postizas", "L\u00e1mpara UV u\u00f1as", "Reloj inteligente", "Set alimentaci\u00f3n beb\u00e9", "Juguetes Montessori"],
  ...
  it: ["Abito da sera", "Leggings sportivi", "Borsa a mano", "Auricolari wireless", "Smartwatch", "Crema viso", "Sneakers", "Orecchini", "Friggitrice ad aria", "Robot aspirapolvere", "Laptop", "Profumo"],
  pl: ["Sukienka wieczorowa", "Legginsy sportowe", "Torebka", "S\u0142uchawki bezprzewodowe", "Smartwatch", "Krem do twarzy", "Sneakersy", "Kolczyki", "Frytkownica bezt\u0142uszczowa", "Robot sprz\u0105taj\u0105cy", "Laptop", "Perfumy"],
};
...
// Hot Deals banner - loads verified affiliate hot products with high commission
async function loadPromos() {
  try {
    const resp = await fetch(`${API_BASE}/hot-deals?currency=${currentCurrency}&country=${currentCountry}&lang=${currentLang}`);
    const data = await resp.json();
    const products = data.products || [];

    if (products.length < 3) return;

    document.getElementById("promoTitle").textContent = "🔥 דילים חמים עם הנחות מטורפות";
    document.getElementById("promoSubtitle").textContent = `${products.length} מוצרים נבחרים עם המחירים הכי טובים`;
...
const SPIN_LABELS = {
  ...
  it: { coupon2: "Coupon $2", freeShip: "Spedizione gratuita!", tryAgain: "Riprova domani", coupon3: "Coupon $3", deal: "Offerta speciale!", tryAgain2: "Riprova domani", coupon5: "Coupon $5", discount10: "10% di sconto!" },
  pl: { coupon2: "Kupon $2", freeShip: "Darmowa wysyłka!", tryAgain: "Spróbuj jutro", coupon3: "Kupon $3", deal: "Oferta specjalna!", tryAgain2: "Spróbuj jutro", coupon5: "Kupon $5", discount10: "10% zniżki!" },
};
...
function buildProductCard(p) {
  ...
  const langLabels = {
    ...
    it: { cta: '🛒 Compra ora - ', save: 'Risparmia', hot: 'OFFERTA', freeShip: 'Spedizione gratuita', topPick: 'Più venduto', viewing: 'persone stanno guardando' },
    pl: { cta: '🛒 Kup teraz - ', save: 'Oszczędź', hot: 'GORĄCA OFERTA', freeShip: 'Darmowa wysyłka', topPick: 'Najlepszy wybór', viewing: 'osób ogląda teraz' },
  };
...
const pathLangMatch = window.location.pathname.match(/^\/(en|ar|ru|es|pt|tr|fr|de|it|pl)\//);
