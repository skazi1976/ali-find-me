    ...
    return `
      <div class="product-card">
        <a href="${p.affiliate_url}" target="_blank" rel="noopener">
          <img class="product-image" src="${p.image}" alt="${p.title}" loading="lazy" onerror="if(this.dataset.retry==='2'){this.src='data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22300%22 height=%22300%22 fill=%22%23f0f0f0%22%3E%3Crect width=%22300%22 height=%22300%22/%3E%3Ctext x=%2250%25%22 y=%2250%25%22 dominant-baseline=%22middle%22 text-anchor=%22middle%22 fill=%22%23999%22 font-size=%2216%22%3E%F0%9F%93%B7%3C/text%3E%3C/svg%3E';this.onerror=null;}else if(this.dataset.retry==='1'){this.dataset.retry='2';this.src='https://ali-findme-api.ohadf1976.workers.dev/img?url='+encodeURIComponent('${p.image}');}else{this.dataset.retry='1';this.src='${p.image_alt||''}';}">
        </a>
